...
<style>
    ...
    body {
        ...
        background-image: url('/img/bios25_result.webp');
    ...
    <div class="d-flex flex-column justify-content-center align-items-center" style="min-height: 85vh;">
        <div class="text-center pt-2">
            <h4 class="text-uppercase py-2 px-md-5 mt-lg-5 mb-2"
                style="background-color: #FF6002; color: #FFFFFF;">CONGRATULATION</h4>
            <h2 class="text-uppercase" id="resultname" style="color: #1F1F1F;">NAME</h2>
            <div class="d-flex justify-content-center align-items-center" style="gap: 60px; margin-top: 10px;">
                <div>
                    <h5 class="text-uppercase text-center" id="contest" style="color: #FF6002">CONTEST</h5>
                    <h3 class="text-uppercase" id="resultBib" style="color: #FF6002;">BIB</h3>
                </div>
                <div style="border: 4px solid #00ABA3; border-radius: 15px; padding: 20px; margin-top: 10px;">
                    <h4 id="resultTime" style="color: #00ABA3">RESULT : TIME</h4>
                </div>
            </div>
        </div>
    </div>
